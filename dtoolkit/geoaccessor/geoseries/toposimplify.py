...
def toposimplify(
    ...
    """
    Returns a :class:`~geopandas.{klass}` containing a simplified representation of each
    geometry. Similar to :meth:`~geopandas.GeoSeries.simplify`, but keeps shared edges.
