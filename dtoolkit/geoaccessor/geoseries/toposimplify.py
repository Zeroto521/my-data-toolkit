...
def toposimplify(
    ...
    >>> df.toposimplify(0.1).head()
                                                geometry  ...  gdp_md_est
    0  POLYGON ((33.90367 -0.95000, 30.76984 -1.01452...  ...         NaN
    1  POLYGON ((-8.66561 27.65644, -8.81786 27.65644...  ...     63177.0
    2  POLYGON ((29.33999 -4.50001, 29.27634 -3.29391...  ...       907.0
    3  POLYGON ((41.58509 -1.68324, 42.04156 -0.91918...  ...         NaN
    4  POLYGON ((39.20220 -4.67675, 39.60493 -4.34650...  ...         NaN
    <BLANKLINE>
    [5 rows x 6 columns]
