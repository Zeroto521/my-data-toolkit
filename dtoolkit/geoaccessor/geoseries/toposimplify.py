...
def toposimplify(
    ...
    >>> df.toposimplify(0.1).head()
           pop_est  ...                                           geometry
    1   53950935.0  ...  POLYGON ((-8.66561 27.65644, -8.81786 27.65644...
    2     603253.0  ...  POLYGON ((29.33999 -4.50001, 29.27634 -3.29391...
    11  83301151.0  ...  POLYGON ((19.89576 -24.76780, 19.89542 -21.849...
    12   7531386.0  ...  POLYGON ((-16.71374 13.59499, -15.62454 13.623...
    13  47615739.0  ...  POLYGON ((-11.51397 12.44302, -11.45617 12.076...
    <BLANKLINE>
    [5 rows x 6 columns]
